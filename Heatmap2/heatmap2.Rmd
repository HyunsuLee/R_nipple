...
cor_hclu_com <-hclust(cor_t.dist, method = "average")
clusterCut <- cutree(cor_hclu_avg, 3)
cor_dend <- as.dendrogram(cor_hclu_com)
heatmap.2(heat.mat.log.nq, col=r, scale = "row", cexCol = 0.7, labRow = NA, key = T, trace = "none", density.info = "none", dendrogram = "row", Colv = NA, Rowv=cor_dend)
